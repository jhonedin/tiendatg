...
class MetadataAmazonDataset(models.Model):
    ...
    imurl = models.CharField(max_length=3000, blank=True, null=True)
    brand = models.CharField(max_length=1000, blank=True, null=True)
    description = models.CharField(max_length=10000, blank=True, null=True)
    categories = models.CharField(max_length=3000, blank=True, null=True)
...
class ReviewsAmazonDataset(models.Model):
    ...
    asin = models.ForeignKey(MetadataAmazonDataset, models.DO_NOTHING, db_column='asin')
    reviewername = models.CharField(max_length=500, blank=True, null=True)
    overall = models.CharField(max_length=20, blank=True, null=True)
